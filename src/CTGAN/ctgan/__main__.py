...
def _parse_args():
    ...
    parser.add_argument(
        "-d",
        "--discrete",
        default="workclass,education,marital-status,occupation,relationship,race,sex,native-country,income",
    ...
    parser.add_argument(
        "--data",
        default="/home/ana/University/MitigatingBiasInDataScience/processed_data/adult.csv",
        help="Path to training data",
    )
    parser.add_argument(
        "--output", default="ctgan_fake_adult.csv", help="Path of the output file"
    )
