...
class TestDiscriminator(TestCase):
    ...
    def test___init__(self):
        ...
        discriminator = Discriminator(
            input_dim=50, discriminator_dim=discriminator_dim, pac=7
        )
    ...
    def test_forward(self):
        ...
        """
        discriminator = Discriminator(
            input_dim=50, discriminator_dim=[100, 200, 300], pac=7
        )
...
class TestGenerator(TestCase):
    ...
    def test_forward(self):
        ...
        """
        generator = Generator(
            embedding_dim=60, generator_dim=[100, 200, 300], data_dim=500
        )
...
class TestCTGAN(TestCase):
    ...
    def test__validate_discrete_columns(self):
        ...
        with pytest.raises(
            ValueError, match=r"Invalid columns found: {\'doesnt exist\'}"
        ):
